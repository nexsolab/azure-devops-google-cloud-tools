...
Go to the **Service connection** page in the Azure DevOps Project settings menu. (*The URL may be like: `https://dev.azure.com/[organization]/[project]/_settings/adminservices`*).  
...
(*The URL may be like: `https://dev.azure.com/[organization]/[project]/_library?itemType=SecureFiles`*).  
