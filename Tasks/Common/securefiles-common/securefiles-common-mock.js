...
var SecureFileHelpers = /** @class */ (function () {
    ...
    SecureFileHelpers.prototype.downloadSecureFile = function (secureFileId) {
        return __awaiter(this, void 0, void 0, function () {
            var fileName, tempDownloadPath;
            return __generator(this, function (_a) {
                tl.debug('Mock downloadSecureFile with id = ' + secureFileId);
                fileName = "" + secureFileId + SecureFileHelpers.fileExtension;
                tempDownloadPath = "/build/temp/" + fileName;
    ...
    SecureFileHelpers.setFileExtension = function (extension) {
