...
class SecureFileHelpers {
    constructor(retryCount) {
        ...
        const authHandler = azure_devops_node_api_1.getPersonalAccessTokenHandler(serverCreds);
        ...
        if (proxy) {
            options = Object.assign(Object.assign({}, options), { proxy, ignoreSslError: true });
        }
        ;
    ...
    downloadSecureFile(secureFileId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const agentApi = yield this.serverConnection.getTaskAgentApi();
